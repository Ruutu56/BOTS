...
import DispGrounds from './components/pages/DispGrounds';
import AdminHome from './components/pages/AdminHome';
import DispBookings from './components/pages/DispBookings';
import DispChallenges from './components/pages/DispChallenges';
    ...
    <>
      <Router>
        ...
        <Switch>
          ...
          <Route path='/dispgrounds' component={DispGrounds}/>
          <Route path='/dispbookings' component={DispBookings}/>
          <Route path='/dispchallenges' component={DispChallenges}/>
