                 ...
                 <div class="row">
                                ...
                                <div class="row">
                                   <div class="col-xs-12">
                                      <div class="form-group"> <label>CARD NUMBER</label>
                                        <div class="input-group"> <input type="tel" name="card_no" class="form-control"  placeholder="Valid Card Number" value={this.state.card_no} onChange={this.onChange} /> <span class="input-group-addon"><span class="fa fa-credit-card"></span></span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-xs-12"> <button class="btn btn-success btn-lg btn-block" onClick={this.cancel.bind(this)} style={{marginLeft: "10px"}} >Cancel</button> </div>
                            <div class="col-xs-12"> <button class="btn btn-success btn-lg btn-block" onClick={this.logout.bind(this)} style={{marginLeft: "20px"}} >Logout</button> </div>
                        </div>
                    </div>
                </div>
            </div>
